...
const KanbanColumn = ({ title, statusKey, tasks = [], workspaceId, projectId, onAddTask, onSelectTask }) => {
    return (
        <div className="bg-muted/40 border border-border rounded-2xl flex flex-col max-h-full min-h-[500px]">
            ...
            <div className="p-3 flex flex-col gap-3 flex-1 overflow-y-auto">
                ...
                {tasks.length === 0 && (
                    <div className="flex-1 flex flex-col items-center justify-center py-10 border border-dashed border-border rounded-xl text-center p-4">
