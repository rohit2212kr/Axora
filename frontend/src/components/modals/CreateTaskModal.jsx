                    ...
                    <div>
                        ...
                        <input type="text" placeholder="e.g. Write API documentation"
                            ...
                            className={`w-full bg-slate-800 text-white placeholder-slate-500 rounded-lg px-3.5 py-2.5 text-sm border outline-none transition focus:ring-2 focus:ring-indigo-500 ${
                                errors.title ? "border-red-500/60" : "border-slate-700 focus:border-indigo-500"
                            }`}
                        />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <select {...register("priority")}
                                className="w-full bg-slate-800 text-white rounded-lg px-3 py-2.5 text-sm border border-slate-700 outline-none transition focus:ring-2 focus:ring-indigo-500 capitalize cursor-pointer">
                        ...
                        <div>
                            ...
                            <select {...register("status")}
                                className="w-full bg-slate-800 text-white rounded-lg px-3 py-2.5 text-sm border border-slate-700 outline-none transition focus:ring-2 focus:ring-indigo-500 cursor-pointer">
                                {STATUSES.map((s) => <option key={s.value} value={s.value}>{s.label}</option>)}
                            </select>
                        </div>
                    </div>

                    {/* Due Date — required by backend */}
                    <div>
                        <label className="block text-sm font-medium text-slate-300 mb-1.5">
                        ...
                        <input type="date"
                            ...
                            className={`w-full bg-slate-800 text-white rounded-lg px-3.5 py-2.5 text-sm border outline-none transition focus:ring-2 focus:ring-indigo-500 [color-scheme:dark] cursor-pointer ${
                                errors.dueDate ? "border-red-500/60" : "border-slate-700 focus:border-indigo-500"
                            }`}
                        />
                        {errors.dueDate && <p className="mt-1.5 text-xs text-red-400">{errors.dueDate.message}</p>}
                    </div>
